...
public class Demo2DirectedGraph {
	...
	public static void main(String[] args) {
		...
		while(true) 
		{ 
			System.out.println("l.Display Adjacency Matrix"); 
			System.out.println("2.Insert a vertex"); 
			System.out.println("3.lnsert an edge"); 
