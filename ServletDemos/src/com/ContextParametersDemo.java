...
/**
 * Servlet implementation class ContextParametersDemo
 */
@WebServlet("/ContextParametersDemo")
public class ContextParametersDemo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<br> ");
		ctx.setAttribute("MyData", "MyValue");
